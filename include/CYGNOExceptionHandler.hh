...
#ifndef CYGNOExceptionHandler_h
#define CYGNOExceptionHandler_h 1
...
class CYGNOExceptionHandler : public G4VExceptionHandler
{

public:

  CYGNOExceptionHandler();
  virtual ~CYGNOExceptionHandler();
  G4bool operator==(const CYGNOExceptionHandler &right) const;
  G4bool operator!=(const CYGNOExceptionHandler &right) const;
...
private:
  ...
  CYGNOExceptionHandler(const CYGNOExceptionHandler &right);
  CYGNOExceptionHandler& operator=(const CYGNOExceptionHandler &right);
