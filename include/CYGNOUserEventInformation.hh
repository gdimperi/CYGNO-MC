...
#ifndef CYGNOUserEventInformation_h
#define CYGNOUserEventInformation_h 1

class CYGNOUserEventInformation : public G4VUserEventInformation
{
  public:

    CYGNOUserEventInformation();
    virtual ~CYGNOUserEventInformation();
