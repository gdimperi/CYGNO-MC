...
#Directory paths
CODEDIR='/storage/local/home/cygnorm3/'+username+'/CYGNO/CYGNO-MC/' # this folder contains the code of the simulation and the background information (subdir backgrounds/)
OUTDIR='/storage/DATA-03/cygnorm3/CYGNO-MC-data/' # this is the folder where results of the simulations are stored: the folder will contain BSUBOUTDIR and pbs_logs subdirectories containing the outputs of simulation and the logs, respectively. 
...
TMPDIR='/storage/scratch/'+username #this is a temporary directory where the simulation is compiled per each job. It is then cleaned up at the end of each job
ANADIR='' # this folder contains the code to make histograms
BUILDDIR='/storage/local/home/cygnorm3/'+username+'/CYGNO/CYGNO-MC-build/' 
