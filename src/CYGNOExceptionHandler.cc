...
CYGNOExceptionHandler::CYGNOExceptionHandler() 
{
}
...
CYGNOExceptionHandler::CYGNOExceptionHandler(const CYGNOExceptionHandler &)
:G4VExceptionHandler()
{
}

CYGNOExceptionHandler& CYGNOExceptionHandler::operator=(const CYGNOExceptionHandler &)
{
   return *this;
}

G4bool CYGNOExceptionHandler::operator==(const CYGNOExceptionHandler &right) const
{
   return (this == &right);
}
...
G4bool CYGNOExceptionHandler::Notify(const char* originOfException,
...
void CYGNOExceptionHandler::DumpTrackInfo()
{
  G4ApplicationState aps = G4StateManager::GetStateManager()->GetCurrentState();
